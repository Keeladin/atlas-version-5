...
This remains a retrieval substrate rather than durable interpreted memory. Context-capsule generation, durable remember/correct/forget commands, visual attachment indexing, and the separate memory-reasoning worker that decides create/merge/supersede/discard remain staged. Derived lexical/vector indexes remain rebuildable from canonical transcript history.
